...
void Binomial_Heap::Merge(Binomial_Heap &H1, Binomial_Heap &H2, Binomial_Heap &H_merged){
...
void Binomial_Heap::Union(Binomial_Heap &H_in){
...
void Binomial_Heap::UpdateMinPtr(){
...
void Binomial_Heap::Link(BTNode* y, BTNode* z){
    y->parent = z;
...
void Binomial_Heap::InsertArbitrary(BTNode* const inserted_node){
...
BTNode* Binomial_Heap::ExtractMin(){
    if(head_root_list == NULL){
        std::cout<<"Error : The Binomial_Heap is already empty."<<std::endl;
        return NULL;
    }
    ...
    //Reverse the min_child list to construct the new Binomial_Heap.
    ...
    Binomial_Heap* tmp_Heap = new Binomial_Heap();
...
BTNode* Binomial_Heap::Search(const int key){
...
void Binomial_Heap::ExchangeSatelliteInfo(BTNode* const x, BTNode* const y){
...
void Binomial_Heap::ExchangeNodePos(BTNode* const x, BTNode* const y){
    BTNode* tmp = new BTNode();
    tmp->parent = y->parent;
...
bool Binomial_Heap::DecreaseKey(BTNode* const x, const int changed_key){
    if(x == NULL){
...
bool Binomial_Heap::DecreaseKeySatellite(BTNode* const x, const int changed_key){
    if(x == NULL){
        std::cout<<"Error : The input BTNode x is "<<x<<std::endl;
        return false;
    }
